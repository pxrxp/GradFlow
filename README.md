...
### 2. Tensor Abstraction (`tensor.py`)
...
The project includes a clinical classification demonstration in `demo.ipynb`. It utilizes a real-world medical dataset (`medical_data.csv`) to train a model for malignant vs. benign diagnosis.
...
---
*Developed as a structured learning project to explore the inner workings of automatic differentiation and neural network optimization.*
